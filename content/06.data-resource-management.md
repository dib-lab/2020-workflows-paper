...
Aside from the code itself, raw data are the most important files associated with a workflow, as they cannot regenerated if accidentally altered or deleted.
