...
In the "Getting Started" section, discuss a selection of tools and strategies useful for critically assessing sequencing data, quickly gaining insights from large datasets, and conducting computational resource management.
...
While other services such as Git Large File Storage (LFS), Figshare [@url:https://figshare.com/], Zenodo [@url:https://zenodo.org/], and the Dryad Digital Repository (Dryad) each provide important services for sharing and version control, OSF provides the most comprehensive set of free tools for managing data storage and backup.
...
...Finally, selecting and managing computational resources for your datasets.
...
**add bit on workflow-based resource management and/or hpc-integration**
...
#### Critically assess your data / Properly quality control your data / Generate summary statistics
