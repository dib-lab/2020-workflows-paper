...
For example, to preserve the version of code that produced published results you can create a "release" which is a snapshot of the current code and files in a GitHub repository.
