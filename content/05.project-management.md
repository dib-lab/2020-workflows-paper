...
With many input files, even this straightforward workflow can result in hundreds of intermediate files. Fortunately, workflow system coordination alleviates the need for a user to directly manage file interdependencies.
