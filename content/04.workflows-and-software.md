...
These pipeline applications allow users to take advantage of the benefits of workflow software without needing to invest in curating and writing the workflow syntax for each analysis step.
...
These pipeline applications are typically designed to execute a series of standard steps, but many provide varying degrees of customizability ranging from tool choice to parameter specification.
