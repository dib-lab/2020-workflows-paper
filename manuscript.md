...
While the workflow is complex, it is coordinated by a workflow system that alleviates the need for a user to directly manage file interdependencies.](images/rnaseq_dag.png){#fig:rnaseq_workflow height=4in}
